...
var windowSizeCrit = 420;
// my smartphone: min-width : 320px true
...
function mqSmartphone() {
  ...
  return (
    mqMobile() ||
    window.innerWidth < windowSizeCrit ||
...
function displayMediaProperties(canvas, textsize) {
  ...
  var displayStr5 =
    "ge96dpi=" + ge96dpi + " ge144dpi=" + ge144dpi + " ge192dpi=" + ge192dpi;
  var displayStr6 = mqSmartphone()
    ? "Smartphone"
    : mqMobile()
    ? "Tablet"
    : "Desktop";
  ...
  ctx.fillText(
    displayStr1,
    display_xlb + 0.2 * textsize,
    display_ylb - 6.2 * textsize
  );
  ctx.fillText(
    displayStr2,
    display_xlb + 0.2 * textsize,
    display_ylb - 5.2 * textsize
  );
  ctx.fillText(
    displayStr3,
    display_xlb + 0.2 * textsize,
    display_ylb - 4.2 * textsize
  );
  ctx.fillText(
    displayStr4,
    display_xlb + 0.2 * textsize,
    display_ylb - 3.2 * textsize
  );
  ctx.fillText(
    displayStr5,
    display_xlb + 0.2 * textsize,
    display_ylb - 2.2 * textsize
  );
  ctx.fillText(
    displayStr6,
    display_xlb + 0.2 * textsize,
    display_ylb - 1.2 * textsize
  );
  ctx.fillText(
    displayStr7,
    display_xlb + 0.2 * textsize,
    display_ylb - 0.2 * textsize
  );
